...
This app allows you to quickly determine if today, yesterday, or tomorrow is a school holiday in the Netherlands. It provides comprehensive information about holidays in different regions (North, Central, South) and various types of holidays such as Autumn break, Christmas break, Spring break, May holidays, and Summer holidays. You can also add and manage custom holidays and get an overview of all holidays per region. The app includes tokens and flow cards for integrating holiday checks into your workflows, making it easy to automate actions based on school and custom holidays.
...
- Trigger flows when a specific school holiday starts or ends in a selected region.
- Trigger flows when one of your custom holidays starts or ends.
